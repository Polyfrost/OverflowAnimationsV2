...
public abstract class RenderItemMixin {
    ...
    //todo: big sweeping changes, tmrw
    ...
    private List<BakedQuad> overflowAnimations$changeToSprite(List<BakedQuad> quads) {
        if (MainModSettings.INSTANCE.getOldSettings().getItemSprites() && MainModSettings.INSTANCE.getOldSettings().enabled && !overflowAnimations$model.isGui3d() && TransformTypeHook.INSTANCE.shouldBeSprite()) {
    ...
    private void overflowAnimations$modifyNormalValue(WorldRenderer instance, float x, float y, float z, WorldRenderer renderer, BakedQuad quad) {
        if (MainModSettings.INSTANCE.getOldSettings().enabled && !overflowAnimations$model.isGui3d() && !(Minecraft.getMinecraft().currentScreen instanceof GuiFlatPresets)) {
            if (MainModSettings.INSTANCE.getOldSettings().getItemSprites() && MainModSettings.INSTANCE.getOldSettings().getItemSpritesColor() && TransformTypeHook.INSTANCE.shouldNotHaveGlint()) {
    ...
    public void overflowAnimations$disableGlintOnSprite(IBakedModel model, CallbackInfo ci) {
        if (MainModSettings.INSTANCE.getOldSettings().getItemSprites() && MainModSettings.INSTANCE.getOldSettings().getSpritesGlint() && MainModSettings.INSTANCE.getOldSettings().enabled && TransformTypeHook.INSTANCE.shouldNotHaveGlint()) {
            ci.cancel();
        }
    }
    ...
    private void overflowAnimations$translateSprite(ItemStack stack, IBakedModel model, CallbackInfo ci) {
        if (MainModSettings.INSTANCE.getOldSettings().getItemSprites() && MainModSettings.INSTANCE.getOldSettings().enabled && !model.isGui3d() && TransformTypeHook.INSTANCE.shouldNotHaveGlint()) {
    ...
    public void overflowAnimations$modifyModelPosition(ItemStack stack, IBakedModel model, ItemCameraTransforms.TransformType cameraTransformType, CallbackInfo ci) {
        if (MainModSettings.INSTANCE.getOldSettings().enabled && !(stack.getItem() instanceof ItemBanner)) {
                ...
                if (cameraTransformType == ItemCameraTransforms.TransformType.FIRST_PERSON) {
                    if (MainModSettings.INSTANCE.getOldSettings().getFishingRodPosition() && isRod) {
                        GlStateManager.rotate(180.0F, 0.0F, 1.0F, 0.0F);
                        GlStateManager.rotate(50.0F, 0.0F, 0.0F, 1.0F);
                    } else if (MainModSettings.INSTANCE.getOldSettings().getFirstTransformations() && MainModSettings.INSTANCE.getOldSettings().getFirstPersonCarpetPosition() && isCarpet) {
                        GlStateManager.translate(0.0F, -5.25F * 0.0625F, 0.0F);
                    }
                } else if (MainModSettings.INSTANCE.getOldSettings().getThirdTransformations() && cameraTransformType == ItemCameraTransforms.TransformType.THIRD_PERSON
                        && (overflowAnimations$entityLivingBase instanceof EntityPlayer || !MainModSettings.INSTANCE.getOldSettings().getEntityTransforms())) {
                    if (isRod) {
                        GlStateManager.rotate(180.0F, 0.0F, 1.0F, 0.0F);
                        GlStateManager.rotate(110.0F, 0.0F, 0.0F, 1.0F);
                        GlStateManager.translate(0.002F, 0.037F, -0.003F);
                    } else if (MainModSettings.INSTANCE.getOldSettings().getThirdPersonCarpetPosition() && isCarpet) {
    ...
    @Inject(
            ...
            at = @At(
                    value = "INVOKE",
                    target = "Lnet/minecraft/client/renderer/entity/RenderItem;renderItemIntoGUI(Lnet/minecraft/item/ItemStack;II)V"
            )
    )
    ...
    @Redirect(
            ...
            at = @At(
                    value = "INVOKE",
                    target = "Lnet/minecraft/client/renderer/ItemModelMesher;getItemModel(Lnet/minecraft/item/ItemStack;)Lnet/minecraft/client/resources/model/IBakedModel;"
            )
    )
    public IBakedModel overflowAnimations$rodBowModelTexture(ItemModelMesher instance, ItemStack stack) {
        EntityPlayer entityplayer = Minecraft.getMinecraft().thePlayer;
        if (entityplayer != null && MainModSettings.INSTANCE.getOldSettings().getRodBowGuiFix() && MainModSettings.INSTANCE.getOldSettings().enabled) {
