...
object OverflowAnimations {
    ...
    var modConfig: MainModSettings? = null
    ...
    private fun onTick(event: RenderEvent) {
        if (event.stage == Stage.START && Minecraft.getMinecraft().currentScreen == null && Minecraft.getMinecraft().theWorld != null && Minecraft.getMinecraft().thePlayer != null && doTheFunnyDulkirThing && !modConfig!!.oldSettings.didTheFunnyDulkirThingElectricBoogaloo) {
            try {
    ...
    private fun dulkirTrollage() {
        ...
        modConfig!!.oldSettings.didTheFunnyDulkirThingElectricBoogaloo = true
    }
